...
def evaluate_responses(question, responses):
    evaluation_prompt = 'Compare as seguintes respostas de LLMs para mesma pergunta com base em clareza, coerência, criatividade, consistência gramatical e precisão. E me retorne somente os nomes das ias em ordem de melhor resposta sem nenhum texto a mais.'
    evaluation_prompt += f'\n\nPergunta feita:\n{question}\n\nRespostas:\n'
